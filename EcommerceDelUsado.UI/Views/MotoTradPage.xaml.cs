...
public partial class MotoTradPage : ContentPage
{
    public MotoTradPage()
    {
        ...
        BindingContext = new VehiculoViewModel(useCase, "MotoTradicional"); // Filtra por tipo. Auto es el campo "Tipo" en la DB.
    }

    private async void OnMotoTradSelected(object sender, SelectionChangedEventArgs e)
    {
        ...
        await Shell.Current.GoToAsync(nameof(DetalleMotoTradPage), new Dictionary<string, object>
        {
